...
- Once you have learnt about docker networks and can get your containerized application to comunicate to your database, you can update your Dockerfiles to run the migrations before running the application.
